...
class Board():
    def __init__(self, gate_file_list, net_file_list):
        self._gates = gate_file_list
        self._netlist = net_file_list
    ...
    def calculate_costs(self):
        ...
        return (costs, self.calc_intersections(), self.calc_used_gate(), total_cost)
